<div class="panel panel-primary">
	...
	<div class="panel-body"> -->
		<table
			...
			<thead class="a_thead">
				<tr>
					<th colspan="7"><span class="a_shead" >{{{tr('Relations')}}}</span></th>
				</tr>
			</thead>
			<tbody>
